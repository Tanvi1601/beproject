...
\textit{In the end our special thanks to \textbf{Mr. Manish Gupta} for
...
OCR-Preprocessing modules for skew correction, classification of Text- Non text Data and binarization of degraded documents 


\section{ Project Option }
Industry Sponsored Project: CDAC, Pune.
